...
async def get_event_ticketekAU():
    main_page_url = "https://www.ticketfairy.com/search-results?type=upcoming&search=Australia"
    ...
    for item in raws:
        ...
        start_time = start_time_div.split('/')[-1].strip()

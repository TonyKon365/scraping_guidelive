    ...
    if response.data:
        for event in response.data:
            if 'event_location' in event and event['event_location']:
                # Parse the event_location from string to JSON object
...
async def cronjob():
# get_news
#     await get_news_from_eventfinda()
#     await get_news_from_christchurchnz()
#     await get_news_from_voicesnz()
#     await get_news_from_taupowinterfestival()
#     await get_news_from_rotoruanz() #
#     await get_news_from_greenstoneentertainment()
#     await get_news_from_neckofthewoods()
#     await get_news_from_totarastreet()
#     await get_news_from_comedyfestival()
#     await get_news_from_wellingtonnz()
#     await  get_news_from_undertheradar()
#     await get_news_from_aucklandlive()
# #events
